// The marks that make the spaces and tabs in the draft visible.
//
...
// (U+3000) is not in it, and a pad written in Japanese cannot leave it out: a
// full-width space that draws nothing is exactly the character someone turns
// this setting on to find. The rule below marks it, and style.css gives it the
// same dot in its own wider box.
//
...
/** Marks every tab, half-width space and full-width space in the draft. */
