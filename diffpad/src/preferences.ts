...
import { clamp, FONT_SIZE_MAX, FONT_SIZE_MIN, TAB_SIZE_MAX, TAB_SIZE_MIN, type Store, type Theme } from './state'
...
export class Preferences {
  ...
  open(): void {
    ...
    // editors' own chrome, and the rest of the window stops taking input.
    this.root.showModal()
    this.focus()
    void this.loadFonts()
  }
  ...
  private async loadFonts(): Promise<void> {
    ...
    try {
      ...
      console.error('diffpad: failed to list fonts', err)
